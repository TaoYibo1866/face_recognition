...
#classifier_model = '/home/tao/tensorflow/face_ws/models/my_classifier.pkl'
debug = False
recog_threshold = 0.4
...
class Identifier:
    ...
    def identify(self, face):
        if face.embedding is not None:
            ...
            if predictions[0, best_class_indices[0]] > recog_threshold:
                return self.class_names[best_class_indices[0]], str(round(100*predictions[0, best_class_indices[0]], 1))
            else:
                return None, None
